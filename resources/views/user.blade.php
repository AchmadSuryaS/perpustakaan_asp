...
@section('container')
    <div class="mb-5">
        <a href="/dashboard/user/addpetugas">
            <button class="bg-primary p-3 text-white">
                Tambah Petugas <i class="fa-solid fa-plus fa-fw"></i>
            </button>
        </a>
    </div>
    <div class="mb-5">
        @if (session()->has('addpetugas'))
                        ...
                        <tr class="bg-white border-b hover:bg-secondary text-center">
                            ...
                            <td class="px-6 py-4 flex justify-center">
                                <form action="{{ route('userdelete', ['id' => $user->id]) }}" method="POST">
                                    ...
                                    @csrf
                                    <button type="submit"
                                        onclick="return confirm('Apakah kamu yakin ingin mengapus user?')">
                                        <i class="fa-solid fa-square-xmark fa-fw text-3xl text-red-600"></i>
                                    </button>
                                </form>
                                <a href="/dashboard/user/edituser/{{ $user->id }}">
                                    <button type="submit">
